export default class BudgetTracker {
    ...
    static html() {
        ...
        <tbody>
            <tr>
                <td colspan="5" class="controls"><button type="button" class="new-entry">New Entry</button>
                </td>
    ...
    getEntryRows() {
        return Array.from(this.root.querySelectorAll(".entries tr"));       //* takes node list and converts it to an array
    }
